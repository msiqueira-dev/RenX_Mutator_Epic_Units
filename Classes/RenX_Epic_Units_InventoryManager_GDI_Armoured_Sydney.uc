class RenX_Epic_Units_InventoryManager_GDI_Armoured_Sydney extends Rx_InventoryManager_GDI_Sydney_Suit;
...
DefaultProperties
{
	...
	AvailableSidearmWeapons(0) = class'Rx_Weapon_TiberiumAutoRifle' //class'Rx_Weapon_HeavyPistol'
